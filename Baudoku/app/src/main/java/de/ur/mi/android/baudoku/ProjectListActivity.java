...
public class ProjectListActivity extends AppCompatActivity {
    ...
    private ArrayList<ProjectListItem> projects;
    ...
    private void refreshProjectList() {
            ArrayList temp = projectDB.getAllProjects();
            projects.clear();
    ...
    private void initDatabase() {
        projectDB = new ProjectDatabase(this);
        projectDB.open();
    }

    private void initProjectList() {
        projects = new ArrayList <ProjectListItem>();
    ...
    public static class ProjectListFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ListView listView = (ListView) rootView.findViewById(R.id.projects_list);
            return rootView;
        }
    }
